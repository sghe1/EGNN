"""
Visualization utilities for EGNN predictions.

This module contains functions for visualizing mesh predictions and loading prediction data.
"""
...
from egnn_plots import plot_stress_scatter
